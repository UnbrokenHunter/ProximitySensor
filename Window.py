...
class ButtonFrame(tk.CTkFrame):
    def DebugMode(self):
        ...
        print("Debug Mode: ", Globals.DebugMode)
        ...
        if Globals.DebugMode:
            self.simulated = tk.CTkCheckBox(master=self, text="Simulated", command=Simulated, height=50, font=("Helvetica", 20))
            self.simulated.deselect()
            self.simulated.place(x=0, y=0)
        else:
            self.simulated.destroy()
    ...
    def __init__(self, master, **kwargs):
        ...
        self.debugMode = tk.CTkCheckBox(master=self, text="Debug Mode", command=self.DebugMode, height=50, font=("Helvetica", 20))
        self.debugMode.deselect()
        self.debugMode.grid(row=5, column=0, padx=(10, 10), pady=10, sticky="ew")
