...
class Frame(tk.CTkFrame):     
    ...
    def __init__(self, master, **kwargs):
        ...
        self.titleFrame.grid(row=0, column=0, columnspan=2, padx=10, pady=20, sticky="nsew")
        ...
        self.driver.grid(row=2, column=0, padx=10, pady=(3, 30), sticky="ew")
        ...
        self.enableTracking.grid(row=3, column=0, padx=10, pady=10, sticky="ew")
        ...
        self.lapFilters.grid(row=4, column=0, padx=10, pady=10, sticky="ew")
